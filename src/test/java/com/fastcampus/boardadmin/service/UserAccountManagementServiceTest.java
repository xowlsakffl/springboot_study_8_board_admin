...
import com.fastcampus.boardadmin.dto.properties.ProjectProperties;
import com.fastcampus.boardadmin.dto.response.UserAccountClientResponse;
...
class UserAccountManagementServiceTest {
    ...
    class RestTemplateTest {
        ...
        void givenNothing_whenCallingUserAccountsApi_thenReturnsUserAccountList() throws Exception {
            // Given
            UserAccountDto expectedUserAccount = createUserAccountDto("ams", "Ams");
        ...
        void givenUserAccountId_whenCallingUserAccountApi_thenReturnsUserAccount() throws Exception {
            // Given
            String userId = "uno";
            UserAccountDto expectedUserAccount = createUserAccountDto(userId, "Ams");
            server
